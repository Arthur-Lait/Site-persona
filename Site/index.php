...
<body>
  ...
  <body style="background-color: #bac1b8;">
    ...
    <?php
      ...
      if(isset($_GET['param'])){
        $p = explode(separator: "/", string: $_GET['param']);
      }

      $page = $p[0] ?? 'Home';
      $paginas = "paginas/{$page}.php";

      if(file_exists(filename: $paginas)){
        include($paginas);
      }else{
    ...
    ?>
      ...
      <section>
        <h2>Nossa Empresa</h2>
        <h1>ASDASDASDASD</h1>
        <p>Este é o conteúdo principal da sua página inicial. Você pode adicionar texto, imagens e outros elementos
          aqui.</p>
      </section>
    </main>
